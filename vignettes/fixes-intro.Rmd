...
event_study <- run_es(
  ...
  time       = year, 
  timing     = 1998, 
  lead_range = 18,              # Corresponds to years 2000-2004 (relative time: -5 to -1)
  lag_range  = 17,              # Corresponds to years 2006-2009 (relative time: 1 to 4)
  fe         = firm_id + year, 
  cluster    = "state_id", 
  baseline   = -1, 
  interval   = 1
...
- `run_es()`:
    ...
    - Constructs and estimates a fixed effects regression model using `fixest::feols()`.
